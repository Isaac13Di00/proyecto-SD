...
public class VentanaProductos extends JFrame {
		...
		btnEditar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (filaSeleccionada >= 0) {
					...
					JOptionPane.showMessageDialog(VentanaProductos.this, "Seleccione un producto para editar.", "Error",
	...
	private void editarProducto(int fila) {
		...
		String nombre = JOptionPane.showInputDialog(VentanaProductos.this, "Ingrese el nuevo nombre:",
				producto.getNombre());
		if (nombre != null) {
			double precio = Double.parseDouble(JOptionPane.showInputDialog(VentanaProductos.this,
					"Ingrese el nuevo precio:", producto.getPrecio()));
